            ...
            if (cartas_pares.length === 0) guardar(this); // this es la carta que tocamos 
                ...
                if (cartas_pares[0] === cartas_pares[2]) {
                    ...
                    if (cartas_abiertas.length === 24) {
                        document.getElementById("fin").innerHTML = "¡¡You made it! You won!! ¡¡Now will you be a test subject or not?!!";
                        ...
                        document.getElementById("autor").innerHTML = "Thanks for playing. TW: JoseLandaez_ Discord: JoseL#9748"
                        //fin juego
                    }
...
const volver = () => {
    document.getElementById(cartas_pares[1]).style.background = "url('img/portada.jpg')";
    document.getElementById(cartas_pares[3]).style.background = "url('img/portada.jpg')";
    limpiar();
}
